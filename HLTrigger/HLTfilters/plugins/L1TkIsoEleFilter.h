#ifndef L1TkIsoEleFilter_h
#define L1TkIsoEleFilter_h
...
class L1TkIsoEleFilter : public HLTFilter {
public:
  explicit L1TkIsoEleFilter(const edm::ParameterSet&);
  ~L1TkIsoEleFilter() override;
...
private:
  ...
  double TkIsoEleOfflineEt(double Et, double Eta, const L1TObjScalingConstants& scalingConstants) const;
};

#endif  //L1TkIsoEleFilter_h
