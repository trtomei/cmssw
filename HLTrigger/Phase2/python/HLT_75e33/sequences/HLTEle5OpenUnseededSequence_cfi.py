...
)+cms.ignore(hltEle5WPTightClusterShapeSigmavvUnseededFilter)+cms.ignore(hltEle5WPTightClusterShapeSigmawwUnseededFilter)+cms.ignore(hltEle5WPTightHgcalHEUnseededFilter)+HLTDoLocalHcalSequence +
    HLTFastJetForEgamma +
    cms.ignore(hltEle5WPTightHEUnseededFilter)+cms.ignore(hltEle5WPTightEcalIsoUnseededFilter)+cms.ignore(hltEle5WPTightHgcalIsoUnseededFilter)+HLTPFHcalClusteringForEgamma +
    cms.ignore(hltEle5WPTightHcalIsoUnseededFilter)+HLTElePixelMatchUnseededSequence +
    cms.ignore(hltEle5WPTightPixelMatchUnseededFilter)+cms.ignore(hltEle5WPTightPMS2UnseededFilter)+HLTGsfElectronUnseededSequence +
    cms.ignore(hltEle5WPTightGsfOneOEMinusOneOPUnseededFilter)+cms.ignore(hltEle5WPTightGsfDetaUnseededFilter)+cms.ignore(hltEle5WPTightGsfDphiUnseededFilter)+cms.ignore(hltEle5WPTightBestGsfNLayerITUnseededFilter)+cms.ignore(hltEle5WPTightBestGsfChi2UnseededFilter)+hltEle5DphiUnseededFilter +
    cms.ignore(hltEle5WPTightGsfTrackIsoFromL1TracksUnseededFilter)+HLTTrackingV61Sequence +
