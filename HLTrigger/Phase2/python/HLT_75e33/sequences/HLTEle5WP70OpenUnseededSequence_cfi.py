...
)+cms.ignore(hltEle5WP70ClusterShapeSigmavvUnseededFilter)+cms.ignore(hltEle5WP70ClusterShapeSigmawwUnseededFilter)+cms.ignore(hltEle5WP70HgcalHEUnseededFilter)+HLTDoLocalHcalSequence +
    HLTFastJetForEgamma +
    cms.ignore(hltEle5WP70HEUnseededFilter)+cms.ignore(hltEle5WP70EcalIsoUnseededFilter)+cms.ignore(hltEle5WP70HgcalIsoUnseededFilter)+HLTPFHcalClusteringForEgamma +
    cms.ignore(hltEle5WP70HcalIsoUnseededFilter)+HLTElePixelMatchUnseededSequence +
    cms.ignore(hltEle5WP70PixelMatchUnseededFilter)+cms.ignore(hltEle5WP70PMS2UnseededFilter)+HLTGsfElectronUnseededSequence +
    cms.ignore(hltEle5WP70GsfOneOEMinusOneOPUnseededFilter)+cms.ignore(hltEle5WP70GsfDetaUnseededFilter)+cms.ignore(hltEle5WP70GsfDphiUnseededFilter)+cms.ignore(hltEle5WP70BestGsfNLayerITUnseededFilter)+cms.ignore(hltEle5WP70BestGsfChi2UnseededFilter)+hltEle5DphiUnseededFilter +
    cms.ignore(hltEle5WP70GsfTrackIsoFromL1TracksUnseededFilter)+HLTTrackingV61Sequence +
